...
- (void)initializeMapTable
{
    ...
    [workCodeDic setObject:@"110"   forKey:@"신규등록[OA]"];
    [workCodeDic setObject:@"111"   forKey:@"관리자변경[OA]"];
    [workCodeDic setObject:@"112"   forKey:@"재물조사[OA]"];
    [workCodeDic setObject:@"113"   forKey:@"불용요청[OA]"];
    [workCodeDic setObject:@"114"   forKey:@"비품연식조회[OE]"];
    [workCodeDic setObject:@"115"   forKey:@"납품확인[OA]"];
    [workCodeDic setObject:@"116"   forKey:@"대여등록[OA]"];
    [workCodeDic setObject:@"117"   forKey:@"대여반납[OA]"];
