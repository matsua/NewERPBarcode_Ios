...
- (void)start
{
    ...
    if (self.scrollview == nil) {
        ...
        [label setFrame:CGRectMake(self.frame.size.width,0,labelSize.width,self.frame.size.height)];
...
- (void)startScrolling {
    ...
    if (labelSize.width < self.frame.size.width) {
        [label setFrame:CGRectMake(0, 0, labelSize.width, self.frame.size.height)];
        return;
    }
